    ...
    <div class="edit-card">
        ...
        <form method="POST" action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data">
            ...
            <div class="cover-upload-zone" id="coverZone" onclick="document.getElementById('coverInput').click()">
                @if($post->thumbnail)
                    <img id="coverPreview" src="{{ Storage::disk('public')->url($post->thumbnail) }}" alt="" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;border-radius:10px;">
