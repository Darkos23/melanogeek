...
<div class="auth-page">
    ...
    <div class="auth-left">
        ...
        <div class="auth-left-bottom">
            <h2 class="auth-tagline">Nouveau<br>départ,<br><span>nouveau</span> mot de passe.</h2>
            <p class="auth-left-desc">Choisis un mot de passe fort pour sécuriser ton compte créateur.</p>
        </div>
    </div>
    ...
    <div class="auth-right">
        <div class="auth-form-wrap">
            ...
            <div class="auth-subtitle">Choisis un mot de passe sécurisé pour ton compte.</div>
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-input {{ $errors->has('password_confirmation') ? 'is-error' : '' }}"
