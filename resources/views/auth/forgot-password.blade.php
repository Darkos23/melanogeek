...
<style>
    ...
    .auth-title { font-family:var(--font-head);font-size:clamp(1.4rem,3.5vw,1.75rem);font-weight:800;letter-spacing:-.02em;color:var(--cream);margin-bottom:6px;white-space:nowrap; }
